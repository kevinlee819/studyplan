...
public class MongoPageHelper {
    ...
    public <T> PageResult<T> pageQuery(Query query, Class<T> entityClass,Integer pageNum, String collectionName) {
        if (pageNum == null || pageNum <= 0){
            return pageQuery(query, entityClass, Function.identity(), DEFAULT_PAGE_SIZE, FIRST_PAGE_NUM, null,collectionName);
        }
        return pageQuery(query, entityClass, Function.identity(), DEFAULT_PAGE_SIZE, pageNum, null,collectionName);
    }
    ...
    public <T> PageResult<T> pageQuery(Query query, Class<T> entityClass, Integer pageSize,
        ...
        if (pageNum == null || pageNum <= 0){
            ...
            return pageQuery(query, entityClass, Function.identity(), pageSize, FIRST_PAGE_NUM, null,collectionName);
        }
